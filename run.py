...
def get_sales_data():
    ...
    via the terminal, which has to be a string of 6 numbers seperated by commas. The loop will repeat until data is valid.
    """
    while True:
        print("Please enter sales data from the last market.")
        print("Data should be six numbers, seperatedby commas.")
...
def get_last_5_entries_sales():
    ...
    the last 5 entries for each sandwhich and returns 
